  ...
  render() {
    const addDoenca = this.props.adm ? (
      <View style={style.containerInfo}>
        <TouchableOpacity
          ...
          onPress={() => this.setState({showAddDoenca: true})}>
    ...
    return (
      <KeyboardAvoidingView style={style.background}>
        <AddDoenca
          isVisible={this.state.showAddDoenca}
          onCancel={() => this.setState({showAddDoenca: false})}
        />
        <ImageBackground
