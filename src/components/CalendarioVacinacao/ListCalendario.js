  ...
  render() {
    const addCalendario = this.props.adm ? (
      <TouchableOpacity
        ...
        onPress={() => this.setState({showAddCalendario: true})}>
    ...
    return (
      <KeyboardAvoidingView style={style.background}>
        <AddCalendario
          isVisible={this.state.showAddCalendario}
          onCancel={() => this.setState({showAddCalendario: false})}
        />
        <ImageBackground
          ...
          <View style={style.containerInfo}>{addCalendario}</View>

          <View style={style.container}>
            <FlatList
              data={this.props.calendario}
