  ...
  render() {
    const admTela = this.props.adm ? (
      <TouchableOpacity
        ...
        onPress={() => Actions.listaMinhasVacinasadm()}>
        <Image
      ...
      <TouchableOpacity
        style={style.btnContainer}
        onPress={() => Actions.listaMinhasVacinas()}>
        <Image
          source={require('../../assets/vacina.png')}
          style={style.imageButton}
        />
        ...
        <ImageBackground
          ...
          <ScrollView style={style.scroll}>
            ...
            <View style={style.container}>
              <TouchableOpacity
                style={style.btnContainer}
                onPress={() => Actions.listaCalendario()}>
                <Image
            ...
            <View style={style.container}>
              <TouchableOpacity
                style={style.btnContainer}
                onPress={() => Actions.listainformacaodoenca()}>
                <Image
